...
<Info>
These docs configure their own API reference in an upcoming release, and this page will then carry a live embed of a real Readsmith endpoint. The syntax above is complete and current.
</Info>
